Ext.define('LDA.helper.ChemspiderCompoundReader', {
    ...
    readRecords: function(data) {
        ...
        chemspiderLinkOut = 'http://ops.rsc.org/' + chemSpiderUri.split('/').pop();
        ...
        if(em != null) {
            record = Ext.create('LDA.model.CompoundModel', {
                ...
                full_mwt: pt.molweight != null ? pt.molweight : null,
                full_mwt_src: pt[LDA.helper.LDAConstants.LDA_IN_DATASET] != null ? pt[LDA.helper.LDAConstants.LDA_IN_DATASET] : null,
                full_mwt_item: chemspiderLinkOut,
                ...
                molformula: pt.molformula != null ? pt.molformula : null,
                molformula_src: pt[LDA.helper.LDAConstants.LDA_IN_DATASET] != null ? pt[LDA.helper.LDAConstants.LDA_IN_DATASET] : null,
                molformula_item: chemspiderLinkOut,
                ...
                rtb: pt.rtb != null ? pt.rtb : null,
                rtb_src: pt[LDA.helper.LDAConstants.LDA_IN_DATASET] != null ? pt[LDA.helper.LDAConstants.LDA_IN_DATASET] : null,
                rtb_item: chemspiderLinkOut,
