Ext.define('LSP.view.feedback.HomePanel', {
    ...
    html : '<div class="welcome-text-heading">Welcome to the Open PHACTS Explorer</div>'  +
                ...
                + '<br><br><div class="welcome-text centre"><ul class="inline-list"><li><a href="http://www.openphacts.org/tutorials" target="_blank">tutorials</a></li><a href="http://www.openphacts.org/explorer/160" target="_blank">feedback</a><li></li><li><a href="http://www.openphacts.org/known-issues-with-beta-open-phacts-explorer-" target="_blank">known issues</a></li><li><a href="http://www.openphacts.org/the-project">About us & Acknowledgments</a></li></ul></div>',
items: [{
        xtype: 'container',
        layout : {
            type : 'hbox',
