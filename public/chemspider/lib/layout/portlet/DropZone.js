Ext.define('CS.layout.portlet.DropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        CS.layout.portlet.DropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        CS.layout.portlet.DropZone.superclass.unreg.call(this);
    }
});
